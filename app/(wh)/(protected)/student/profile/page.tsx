...
export default function StudentProfile() {
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.put(`/student/${user.profileId ?? user.id}`, {
        email: editFormData.email,
      });
      addMessage('Student profile updated successfully!', 'success');
    } catch (error) {
      console.error('Failed to update student profile:', error);
      addMessage('Failed to update profile. Please try again.', 'error');
    } finally {
  ...
  return (
    <div className="space-y-6 mx-auto max-w-4xl p-6">
      <div className="bg-gradient-to-r from-violet-600 to-purple-600 rounded-xl p-8 text-white shadow-lg">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-violet-100 mt-1">Student Account</p>
